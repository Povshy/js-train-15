...
function generateRandomPassword(length) {
  ...
  for (let key = 0; key < length; key++) {
    let ranpass = Math.floor(Math.random() * characters.length);

    pass += characters.at(ranpass);
  }
...
function estimateInvestment(principal, interestRate, years) {
  ...
  if (
    ...
    console.error("Помилка: аргументи мають бути числами.");
    return null;
  }
